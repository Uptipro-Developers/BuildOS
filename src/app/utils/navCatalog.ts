...
export const NAV_CATALOG: Record<NavAppKey, NavCatalogItem[]> = {
  ...
  finance: [
    ...
    { id: "/apps/finance/config", label: "Finance Configuration", section: "Configuration" },
    { id: "/apps/finance/process-mapping", label: "Process Mapping", section: "Configuration" },
  ],
  hr: [
    ...
    { id: "/apps/hr/hr-general-setup", label: "General Setup", section: "General Setup" },
    { id: "/apps/hr/base-calendar", label: "Base Calendar", section: "General Setup" },
    ...
    { id: "/apps/hr/leave-type-setup", label: "Leave Type Setup", section: "Leave Setup" },
    { id: "/apps/hr/claim-type-setup", label: "Claim Type Setup", section: "Claims Setup" },

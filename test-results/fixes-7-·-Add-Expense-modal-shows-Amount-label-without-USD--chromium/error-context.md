...
- Name: fixes.spec.ts >> 7 · Add Expense modal shows Amount label without (USD)
- Location: e2e/fixes.spec.ts:189:1
...
Expected substring: not "(USD)"
Received string:        "Amount (USD) *"
```
